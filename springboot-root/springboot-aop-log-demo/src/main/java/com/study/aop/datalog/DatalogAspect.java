...
import com.study.aop.domain.ActionType;
import com.study.aop.domain.ChangeItem;
import com.study.aop.util.DiffUtil;
...
public class DatalogAspect {
    ...
    @Pointcut("execution(public * com.study.aop.dao.*.save*(..))")
    public void save(){

    }

    @Pointcut("execution(public * com.study.aop.dao.*.delete*(..))")
    public void delete(){
